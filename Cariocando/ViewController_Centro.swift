...
class ViewController_Centro: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let placesPath = Bundle.main.path(forResource: "Centro", ofType: "plist") {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //cell customizada
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell_Centro", for: indexPath) as! TableViewCell_Listas    //identificador
