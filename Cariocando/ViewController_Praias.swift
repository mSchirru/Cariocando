...
class ViewController_Praias: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let placesPath = Bundle.main.path(forResource: "Praias", ofType: "plist") {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //cell customizada
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell_Praias", for: indexPath) as! TableViewCell_Listas    //identificador
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let indexPath = tableView.indexPathForSelectedRow {
            ...
            let detailVC = segue.destination as! ViewControllerDetalhesPraia
