...
class ViewController_Horto: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let placesPath = Bundle.main.path(forResource: "Horto", ofType: "plist") {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //cell customizada
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell_Horto", for: indexPath) as! TableViewCell_Listas    //identificador
